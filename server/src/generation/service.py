...
from src.generation.schemas import AcceptedCodeLanguages, AcceptedNaturalLanguages, \
    GenerativeTransformerModel, SystemPrompt
from .constants import ANNOTATE_PROMPT, ANALYSE_PROMPT, REVISE_PROMPT, EXPLAIN_PROMPT, DEFINE_PROMPT, \
    ANNOTATE_CODE_PREFIX, EXPLAIN_CODE_PREFIX, REVISE_CODE_PREFIX, \
    ANALYSE_CODE_PREFIX, DEFINE_CODE_PREFIX, COMPLEXITY_PARAMETER_TAG \
